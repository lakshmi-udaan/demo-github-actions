...
You can also add your own metrics by following the instructions below under [Build your own custom metrics using snorql](https://lakshmi-udaan.github.io/demo-github-actions/sections/build-custom-metrics/).
